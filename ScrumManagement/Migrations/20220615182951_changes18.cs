    ...
    public partial class changes18 : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StrengthsId = table.Column<int>(type: "int", nullable: false),
                    TeamMembersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StrengthsTeamMember", x => new { x.StrengthsId, x.TeamMembersId });
                    table.ForeignKey(
                        name: "FK_StrengthsTeamMember_Strengths_StrengthsId",
                        column: x => x.StrengthsId,
                        principalTable: "Strengths",
                        principalColumn: "Id",
