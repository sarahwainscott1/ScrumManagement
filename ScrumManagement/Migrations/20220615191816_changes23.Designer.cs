...
namespace ScrumManagement.Migrations
{
    ...
    [Migration("20220615191816_changes23")]
    partial class changes23
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StrengthsTeamMember", b =>
                {
                    b.Property<int>("IndividualStrengthsId")
                        .HasColumnType("int");

                    b.Property<int>("TeamMembersId")
                        .HasColumnType("int");

                    b.HasKey("IndividualStrengthsId", "TeamMembersId");

                    b.HasIndex("TeamMembersId");

                    b.ToTable("StrengthsTeamMember");
                });
            ...
            modelBuilder.Entity("StrengthsTeamMember", b =>
                {
                    b.HasOne("ScrumManagement.Models.Strengths", null)
                        .WithMany()
                        .HasForeignKey("IndividualStrengthsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
